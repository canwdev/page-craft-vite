import{d as P,Y as i,an as Y,a2 as X,a3 as y,bH as Z,ac as k,bI as q,ab as O,a6 as I,r as $,af as W,m as S,a5 as C,a9 as M,o as J,ax as A,l as U,w as Q,az as ee,bd as te,be as ne,bJ as oe,bK as se,bg as D,bL as re,aw as ae,ad as ie,bM as le,bN as ce,a4 as V,ba as de,al as ue,A as fe,bO as ve,ar as he,b as pe,c as ge,x as me,B as be,I as ye,aZ as ze,bP as xe}from"./index-ve-9jXjp.js";const ke=P({name:"ArrowBack",render(){return i("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},i("path",{d:"M0 0h24v24H0V0z",fill:"none"}),i("path",{d:"M19 11H7.83l4.88-4.88c.39-.39.39-1.03 0-1.42-.39-.39-1.02-.39-1.41 0l-6.59 6.59c-.39.39-.39 1.02 0 1.41l6.59 6.59c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L7.83 13H19c.55 0 1-.45 1-1s-.45-1-1-1z"}))}}),Se=Y&&"loading"in document.createElement("img"),_e=(e={})=>{var a;const{root:s=null}=e;return{hash:`${e.rootMargin||"0px 0px 0px 0px"}-${Array.isArray(e.threshold)?e.threshold.join(","):(a=e.threshold)!==null&&a!==void 0?a:"0"}`,options:Object.assign(Object.assign({},e),{root:(typeof s=="string"?document.querySelector(s):s)||document.documentElement})}},H=new WeakMap,L=new WeakMap,F=new WeakMap,we=(e,a,s)=>{if(!e)return()=>{};const o=_e(a),{root:d}=o.options;let n;const f=H.get(d);f?n=f:(n=new Map,H.set(d,n));let l,r;n.has(o.hash)?(r=n.get(o.hash),r[1].has(e)||(l=r[0],r[1].add(e),l.observe(e))):(l=new IntersectionObserver(g=>{g.forEach(h=>{if(h.isIntersecting){const p=L.get(h.target),b=F.get(h.target);p&&p(),b&&(b.value=!0)}})},o.options),l.observe(e),r=[l,new Set([e])],n.set(o.hash,r));let u=!1;const v=()=>{u||(L.delete(e),F.delete(e),u=!0,r[1].has(e)&&(r[0].unobserve(e),r[1].delete(e)),r[1].size<=0&&n.delete(o.hash),n.size||H.delete(d))};return L.set(e,v),F.set(e,s),v},Re=X("n-avatar-group"),Oe=y("avatar",`
...
`,[Z(k("&","--n-merged-color: var(--n-color-modal);")),q(k("&","--n-merged-color: var(--n-color-popover);")),k("img",`
 width: 100%;
 height: 100%;
 `),O("text",`
 white-space: nowrap;
